...
const api: ElectronApi = {
  ...
  goals: {
    ...
    getById: (id) => ipcRenderer.invoke("goals:getById", { id }),
    getProgress: (id) => ipcRenderer.invoke("goals:getProgress", { id }),
  ...
  debts: {
    ...
    getById: (id) => ipcRenderer.invoke("debts:getById", { id }),
    getProgress: (id) => ipcRenderer.invoke("debts:getProgress", { id }),
